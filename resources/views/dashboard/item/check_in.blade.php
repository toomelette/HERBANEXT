...
<section class="content">
    ...
    <div class="box box-solid">
      ...
      <div class="box-header with-border">
        <h2 class="box-title"  style="padding-top: 5px;">Check In Item</h2>
      ...
      <form method="POST" autocomplete="off" action="{{ route('dashboard.item.check_in_post', $item->slug) }}">
        ...
        <div class="box-body">
          ...
          {!! __form::textbox(
           '3', 'batch_code', 'text', 'Batch Code *', 'Batch Code', old('batch_code'), $errors->has('batch_code'), $errors->first('batch_code'), ''
          ) !!}          
