...
<section class="content">
    ...
    <div class="box box-solid">
      ...
      <div class="box-header with-border">
        <h2 class="box-title">Edit Item Category</h2>
      ...
      <form method="POST" autocomplete="off" action="{{ route('dashboard.item_category.update', $item_category->slug) }}">
        ...
        <div class="box-body">
          <div class="col-md-12">
            ...
            {!! __form::textbox(
              '8', 'description', 'text', 'Description', 'Description', old('description') ? old('description') : $item_category->description, $errors->has('description'), $errors->first('description'), ''
            ) !!}
